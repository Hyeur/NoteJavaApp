...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding"
    ...
    <div class="w3-container">
        <h3 class="w3-padding-64"><b>Manager<br>Page</b></h3>
    </div>
...
<!-- !PAGE CONTENT! -->
<form action="<c:url value="/admin-notes-list"/>" id="currentPageform" method="get">
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
        ...
        <div class="w3-container" style="margin-top:80px" id="showcase">
            ...
            <h1 class="w3-xxxlarge w3-text-red"><b id="permit">Admin</b></h1>
                    ...
                    <div class="col-md-12">
                        <div class="text-container">
                            <form id="formUpdate<%=noteIndex%>" class="updateform">
                                ...
                                <p><textarea name="content" type="text" id="content<%=noteIndex%>" style="display: none;text-align: start">${item.content}</textarea></p>
                            </form>
                        </div>
                    </div>
...
<a href="<c:url value="/admin-notes-list?type=add"/>" class="circle"><i class="fa fa-plus" aria-hidden="true"></i></a>
